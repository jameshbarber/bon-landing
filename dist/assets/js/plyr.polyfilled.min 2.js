'object' == typeof navigator &&
  (function(e, t) {
    ...
    var X = {
        ...
        _('inspectSource', function(e) {
          ...
          (e.exports = function(e, t, r, a) {
            var o = !!a && !!a.unsafe,
              ...
              c = !!a && !!a.noTargetGet;
            'function' == typeof r &&
              ('string' != typeof t || S(r, 'name') || j(r, 'name', t),
            ...
            return (
              ('function' == typeof this && t(this).source) || R.call(this)
            );
          });
      }),
      Z = s,
      ...
      de = function(e, t) {
        var n,
          ...
          r = 0,
          a = [];
        for (n in i) !S(z, n) && S(i, n) && a.push(n);
        for (; t.length > r; ) S(i, (n = t[r++])) && (~fe(a, n) || a.push(n));
        return a;
      },
      pe = [
        'constructor',
    ...
    var qe = ge.f,
      ...
      Ve = {
        f: function(e) {
          return He && '[object Window]' == De.call(e)
            ? (function(e) {
                try {
                  return qe(e);
                } catch (e) {
      ...
      Ye = function(e) {
        ...
        S(t, e) || $e(t, e, { value: Ke.f(e) });
      },
      Ge = O.f,
      Qe = We('toStringTag'),
      Xe = function(e, t, n) {
        e &&
          !S((e = n ? e : e.prototype), Qe) &&
          Ge(e, Qe, { configurable: !0, value: t });
      },
      Je = function(e) {
      ...
      tt = function(e, t) {
        ...
        return (
          Le(e) &&
            ...
            (n !== Array && !Le(n.prototype))
              ? w(n) && null === (n = n[et]) && (n = void 0)
              : (n = void 0)),
        ...
        return function(s, l, c, u) {
          for (
            var h,
              ...
              y = 0,
              b = u || tt,
              w = t ? b(s, g) : n ? b(s, 0) : void 0;
            g > y;
            y++
          )
            if ((o || y in p) && ((f = m((h = p[y]), y, d)), e))
              if (t) w[y] = f;
              else if (f)
                switch (e) {
                  case 3:
      ...
      xt = function(e, t) {
        ...
        return (
          lt(n, { type: 'Symbol', tag: e, description: t }),
          c || (n.description = t),
          n
        );
      },
      Pt =
        Ie && 'symbol' == typeof ht.iterator
          ? function(e) {
      ...
      Ct = function(e, t, n) {
        ...
        return (
          ...
          S(yt, i)
            ? (n.enumerable
                ? (S(e, ot) && e[ot][i] && (e[ot][i] = !1),
                  (n = Fe(n, { enumerable: d(0, !1) })))
                : (S(e, ot) || mt(e, ot, d(1, {})), (e[ot][i] = !0)),
              At(e, i, n))
            : mt(e, i, n)
        );
      },
      ...
      Lt = function(e) {
        var t = k(e, !0),
          n = vt.call(this, t);
        return (
          !(this === ut && S(yt, t) && !S(bt, t)) &&
          (!(n || !S(this, t) || !S(yt, t) || (S(this, ot) && this[ot][t])) ||
            n)
        );
      },
      Mt = function(e, t) {
        ...
        if (n !== ut || !S(yt, i) || S(bt, i)) {
          var r = pt(n, i);
          return (
            !r || !S(yt, i) || (S(n, ot) && n[ot][i]) || (r.enumerable = !0), r
          );
        }
      },
      Ot = function(e) {
    ...
    Ie ||
      (J(
        (ht = function() {
          ...
          return c && Et && At(ut, t, { configurable: !0, set: n }), xt(t, e);
        }).prototype,
        'toString',
        function() {
          return ct(this).tag;
      ...
      (ve.f = jt),
      c &&
        (mt(ht.prototype, 'description', {
          configurable: !0,
          get: function() {
            return ct(this).description;
          },
        }),
        J(ut, 'propertyIsEnumerable', Lt, { unsafe: !0 })),
      (Ke.f = function(e) {
        return xt(We(e), e);
      })),
      Ce({ global: !0, wrap: !0, forced: !Ie, sham: !Ie }, { Symbol: ht }),
      at(Oe(Tt), function(e) {
        Ye(e);
      }),
      Ce(
        { target: 'Symbol', stat: !0, forced: !Ie },
        {
          for: function(e) {
            var t = String(e);
      ...
      Ce(
        { target: 'Object', stat: !0, forced: !Ie, sham: !c },
        {
          create: function(e, t) {
      ...
      Ce(
        { target: 'Object', stat: !0, forced: !Ie },
        { getOwnPropertyNames: Ot, getOwnPropertySymbols: jt }
      ),
      Ce(
        {
          target: 'Object',
    ...
    if (
      c &&
      'function' == typeof _t &&
      (!('description' in _t.prototype) || void 0 !== _t().description)
    ) {
      var Rt = {},
        Ut = function() {
          var e =
      ...
      Nt(Ft, 'description', {
        ...
        Ce({ global: !0, forced: !0 }, { Symbol: Ut });
    }
    Ye('iterator');
    ...
    [].keys &&
      ('next' in (Kt = [].keys())
        ? (Wt = Jt(Jt(Kt))) !== Object.prototype && (zt = Wt)
        : (en = !0)),
      null == zt && (zt = {}),
      S(zt, Zt) ||
        j(zt, Zt, function() {
    ...
    var tn = { IteratorPrototype: zt, BUGGY_SAFARI_ITERATORS: en },
        ...
        if (
          (g &&
            ...
            sn !== Object.prototype &&
              s.next &&
              (Jt(s) !== sn &&
                (on ? on(s, sn) : 'function' != typeof s[cn] && j(s, cn, un)),
              Xe(s, h, !0))),
          'values' == r &&
            p &&
            'values' !== p.name &&
          ...
          if (
            ...
            for (c in l) (!ln && !f && c in d) || J(d, c, l[c]);
          else Ce({ target: t, proto: !0, forced: ln || f }, l);
        return l;
      },
      fn = X.set,
      ...
      pn = hn(
        ...
        'Array',
        function(e, t) {
          fn(this, { type: 'Array Iterator', target: b(e), index: 0, kind: t });
        },
        function() {
          var e = dn(this),
            t = e.target,
    ...
    var mn = function(e, t) {
      ...
      yn = mn('join', ',');
    Ce(
      { target: 'Array', proto: !0, forced: vn || yn },
      {
        join: function(e) {
    ...
    var bn = function(e, t, n) {
      ...
      En = Math.max;
    Ce(
      { target: 'Array', proto: !0, forced: !kn('slice') },
      {
        slice: function(e, t) {
          var n,
            i,
          ...
          if (
            ...
            (n !== Array && !Le(n.prototype))
              ? w(n) && null === (n = n[Tn]) && (n = void 0)
              : (n = void 0),
            n === Array || void 0 === n)
          )
            return Sn.call(a, s, l);
          for (
            i = new (void 0 === n ? Array : n)(En(l - s, 0)), r = 0;
            s < l;
            s++, r++
          )
            s in a && bn(i, r, a[s]);
    ...
    var In =
        '[object z]' !== String(Cn)
          ...
          : Cn.toString,
      Ln = Object.prototype;
    In !== Ln.toString && J(Ln, 'toString', In, { unsafe: !0 });
    var Mn = function() {
        var e = L(this),
          t = '';
        return (
      ...
      J(
        ...
        function() {
          ...
          return (
            ...
            '/' +
            String(
              void 0 === n && e instanceof RegExp && !('flags' in On)
                ? Mn.call(e)
                : n
            )
          );
    ...
    hn(
      ...
      function() {
        ...
        return i >= n.length
          ? { value: void 0, done: !0 }
          : ((e = Fn(n, i)), (t.index += e.length), { value: e, done: !1 });
      }
    );
    ...
    (zn || Wn) &&
      (Bn = function(e) {
        var t,
          ...
          a = this;
        return (
          Wn && (n = new RegExp('^' + a.source + '$(?!\\s)', Mn.call(a))),
          zn && (t = a.lastIndex),
          (i = Hn.call(a, e)),
    ...
    Qn('search', 1, function(e, t, n) {
      return [
        ...
        function(e) {
          ...
          var s = Zn(r, a);
          return (
            ai(r.lastIndex, o) || (r.lastIndex = o), null === s ? -1 : s.index
          );
        },
      ];
    });
          ...
          [
            ...
            function(e, r) {
              ...
              for (var d = 0, p = 0, m = []; p < s.length; ) {
                ...
                if (
                  null === v ||
                  (g = hi(oe(h.lastIndex + (fi ? 0 : p)), s.length)) === d
                )
                  p = Jn(s, p, c);
                else {
    ...
    var xi = We('iterator'),
      ...
      Li =
        ...
        l(function() {
          ...
          return (
            ...
            7 != Ii({}, e)[n] ||
              'abcdefghijklmnopqrst' != Oe(Ii({}, t)).join('')
          );
        })
          ? function(e, t) {
              for (
                var n = Me(e), i = arguments.length, r = 1, a = ve.f, o = f.f;
                i > r;
      ...
      Ui = function(e) {
        var t,
          ...
          h = Ri(a);
        if (
          (c && (l = Ze(l, s > 2 ? arguments[2] : void 0, 2)),
          null == h || (o == Array && Ni(h)))
        )
          for (n = new o((t = oe(a.length))); t > u; u++)
            bn(n, u, c ? l(a[u], u) : a[u]);
        else
          for (r = h.call(a), n = new o(); !(i = r.next()).done; u++)
      ...
      Wi = function(e) {
        var t,
          ...
          o = 0,
          s = 72;
        for (t = 0; t < e.length; t++) (n = e[t]) < 128 && i.push(Vi(n));
        var l = i.length,
          c = l;
        for (l && i.push('-'); c < r; ) {
          var u = 2147483647;
      ...
      sr = function(e, t) {
        if (t)
          for (var n, i, r = t.split('&'), a = 0; a < r.length; )
            (n = r[a++]).length &&
              ((i = n.split('=')),
              e.push({ key: nr(i.shift()), value: nr(i.join('=')) }));
      },
      lr = function(e) {
          ...
          if (w(s))
            if ('function' == typeof (e = Ri(s)))
              for (t = e.call(s); !(n = t.next()).done; ) {
                if (
                  (r = (i = $i(L(n.value))).next()).done ||
                  (a = i.next()).done ||
                  !i.next().done
                )
                  throw TypeError('Expected sequence with length 2');
                l.push({ key: r.value + '', value: a.value + '' });
              }
            else for (o in s) S(s, o) && l.push({ key: o, value: s[o] + '' });
          else
            sr(
              l,
              'string' == typeof s
    ...
    Ki(
      fr,
      {
        ...
        delete: function(e) {
          ...
          for (
            var t = Qi(this), n = t.entries, i = e + '', r = 0;
            r < n.length;
        ...
        getAll: function(e) {
          cr(arguments.length, 1);
          for (
            var t = Qi(this).entries, n = e + '', i = [], r = 0;
            r < t.length;
            r++
          )
        ...
        forEach: function(e) {
          for (
            var t,
              n = Qi(this).entries,
              i = Ze(e, arguments.length > 1 ? arguments[1] : void 0, 3),
              r = 0;
            r < n.length;
      ...
      Ce({ global: !0, forced: !Pi }, { URLSearchParams: hr });
    var dr,
      pr = { URLSearchParams: hr, getState: Qi },
      mr = Un.codeAt,
      gr = s.URL,
      ...
      Nr = function(e, t) {
        ...
        if ('[' == t.charAt(0)) {
          ...
          for (n = '', i = Ui(t), r = 0; r < i.length; r++) n += Vr(i[r], Fr);
          e.host = n;
        }
      },
      _r = function(e) {
        ...
        for (n = [], i = 0; i < t; i++) {
          ...
          if (
            ...
            r.length > 1 &&
              '0' == r.charAt(0) &&
              ((a = xr.test(r) ? 16 : 8), (r = r.slice(8 == a ? 1 : 2))),
            '' === r)
          )
            o = 0;
          else {
        ...
        for (s = n.pop(), i = 0; i < n.length; i++) s += n[i] * Tr(256, 3 - i);
        return s;
      },
      Rr = function(e) {
        var t,
      ...
      Ur = function(e) {
        var t, n, i, r;
        if ('number' == typeof e) {
          for (t = [], n = 0; n < 4; n++) t.unshift(e % 256), (e = kr(e / 256));
          return t.join('.');
        }
        if ('object' == typeof e) {
          for (
            ...
            case Jr:
              if (a && (Er.test(a) || '+' == a || '-' == a || '.' == a))
                ...
                (h = ''),
                  'file' == e.scheme
                    ? (c = ua)
                    : zr(e) && i && i.scheme == e.scheme
                    ? (c = ea)
                    : zr(e)
                    ? (c = ra)
                    : '/' == r[u + 1]
                    ? ((c = ta), u++)
                    : ((e.cannotBeABaseURL = !0), e.path.push(''), (c = ma));
              }
              break;
            case Zr:
            ...
            case ua:
              if (((e.scheme = 'file'), '/' == a || '\\' == a)) c = ha;
                ...
                if (a == dr)
                  ...
                  if ('#' != a) {
                    Yr(r.slice(u).join('')) ||
                      ((e.host = i.host), (e.path = i.path.slice()), Gr(e)),
                      (c = pa);
                    continue;
                  }
                  (e.host = i.host),
      ...
      ba = function(e) {
        var t,
          ...
          o = br(i, { type: 'URL' });
        if (void 0 !== r)
          if (r instanceof ba) t = wr(r);
          else if ((n = ya((t = {}), String(r)))) throw TypeError(n);
    ...
    if (
      (c &&
        je(wa, {
          ...
          username: ja(Ea, function(e) {
            ...
            if (!Kr(t)) {
              t.username = '';
              for (var i = 0; i < n.length; i++) t.username += Vr(n[i], Hr);
            }
          }),
          password: ja(Aa, function(e) {
            ...
            if (!Kr(t)) {
              t.password = '';
              for (var i = 0; i < n.length; i++) t.password += Vr(n[i], Hr);
            }
          }),
      ...
      Na &&
        J(ba, 'createObjectURL', function(e) {
          return Na.apply(gr, arguments);
        }),
        _a &&
          J(ba, 'revokeObjectURL', function(e) {
    ...
    Xe(ba, 'URL'),
      Ce({ global: !0, forced: !Pi, sham: !c }, { URL: ba }),
      (function(e) {
        var t = (function() {
            try {
        ...
        ('URLSearchParams' in e &&
          'a=1' === new e.URLSearchParams('?a=1').toString()) ||
          (function() {
            var r = function e(t) {
    ...
    Ce(
      { target: 'Array', proto: !0, forced: !za || !Wa },
      {
        concat: function(e) {
          var t,
            n,
          ...
          for (t = -1, i = arguments.length; t < i; t++)
            if (((a = -1 === t ? o : arguments[t]), Ka(a))) {
              ...
              for (n = 0; n < r; n++, l++) n in a && bn(s, l, a[n]);
            } else {
    ...
    var $a = rt.filter;
    Ce(
      { target: 'Array', proto: !0, forced: !kn('filter') },
      {
        filter: function(e) {
    ...
    Ce({ target: 'Array', stat: !0, forced: to }, { from: Ui });
    var no = he.includes;
    Ce(
    ...
    var io = rt.map;
    Ce(
      { target: 'Array', proto: !0, forced: !kn('map') },
      {
        map: function(e) {
    ...
    var ro = function(e, t, n) {
      ...
      uo = { start: co(1), end: co(2), trim: co(3) },
      ho = ge.f,
      fo = I.f,
      po = O.f,
      mo = uo.trim,
    ...
    Ce(
      { target: 'String', proto: !0, forced: !Po('includes') },
      {
        includes: function(e) {
          return !!~String(y(this)).indexOf(
            Ao(e),
    ...
    var Do = {
      getConstructor: function(e, t, n, i) {
        var r = e(function(e, a) {
            Ci(e, r, t),
              Oo(e, { type: t, id: Ro++, frozen: void 0 }),
              null != a && Lo(a, e[i], e, n);
          }),
          a = jo(t),
          o = function(e, t, n) {
      ...
      var t,
        ...
        o = (e.exports = (function(e, t, n, i, r) {
          ...
          if (
            ...
            (c = n.getConstructor(t, e, i, u)), (Io.REQUIRED = !0);
          else if (xe(e, !0)) {
            var d = new c(),
              p = d[u](r ? {} : -0, 1) != d,
              m = l(function() {
            ...
            g ||
              ...
              (o.constructor = c)),
              (m || v) && (f('delete'), f('has'), i && f('get')),
              (v || p) && f(u),
              r && o.clear && delete o.clear;
          }
          return (
            (h[e] = c),
            Ce({ global: !0, forced: c != a }, h),
            Xe(c, e),
            r || n.setStrong(c, e, i),
            c
          );
    ...
    Ce(
      { target: 'Object', stat: !0, forced: Object.assign !== Li },
      { assign: Li }
    );
    var Ho = uo.trim;
    Ce(
    ...
    Ce(
      { target: 'Number', proto: !0, forced: Ko },
      {
        toFixed: function(e) {
          var t,
            n,
    ...
    var Jo = { addCSS: !0, thumbWidth: 15, watch: !0 };
    Ce(
    ...
    var Zo = function(e) {
      ...
      os = {
        ...
        empty: function(e) {
          return (
            ts(e) ||
            ((is(e) || rs(e) || as(e)) && !e.length) ||
            (ns(e) && !Object.keys(e).length)
          );
        },
      };
    function ss(e, t) {
      ...
      hs = (function() {
        function e(t, n) {
          Ua(this, e),
            os.element(t)
              ? (this.element = t)
              : os.string(t) && (this.element = document.querySelector(t)),
            os.element(this.element) &&
              os.empty(this.element.rangeTouch) &&
              ((this.config = Object.assign({}, Jo, n)), this.init());
        }
        return (
          qa(
            e,
            ...
            [
              {
                ...
                value: function(t) {
                  var n =
                    ...
                    i = null;
                  if (
                    (os.empty(t) || os.string(t)
                      ? (i = Array.from(
                          document.querySelectorAll(
                            os.string(t) ? t : 'input[type="range"]'
                          )
                        ))
                      : os.element(t)
                      ? (i = [t])
                      : os.nodeList(t)
                      ? (i = Array.from(t))
                      : os.array(t) && (i = t.filter(os.element)),
                    os.empty(i))
                  )
                    return null;
    ...
    Vs ||
      ...
      Ds
        ...
        : Us && !/(iphone|ipod|ipad).*applewebkit/i.test(Ns)
        ? ((Ls = !0),
          (Ms = document.createTextNode('')),
          new Us(xs).observe(Ms, { characterData: !0 }),
          (Is = function() {
            Ms.data = Ls = !Ls;
          }))
        : qs && qs.resolve
        ? ((Os = qs.resolve(void 0)),
          (Is = function() {
            Os.then(xs);
          }))
        : (Is = function() {
    ...
    var Bs,
      ...
      pl = xe(Zs, function() {
        ...
        return !(
          (fl || 'function' == typeof PromiseRejectionEvent) &&
          e.then(t) instanceof n &&
          0 !== cl.indexOf('6.6') &&
          -1 === Ns.indexOf('Chrome/66')
        );
      }),
      ml =
        pl ||
        ...
        if (!t.notified) {
          ...
          Ks(function() {
            for (var r = t.value, a = 1 == t.state, o = 0; i.length > o; ) {
              ...
              try {
                h
                  ? (a || (2 === t.rejection && kl(e, t), (t.rejection = 1)),
                    !0 === h
                      ? (s = r)
                      : (p && p.enter(), (s = h(r)), p && (p.exit(), (c = !0))),
                    s === u.promise
                      ? d(rl('Promise-chain cycle'))
                      : (l = gl(s))
                      ? l.call(s, f, d)
                      : f(s))
                  : d(r);
      ...
      yl = function(e, t, n) {
        var i, r;
        dl
          ? (((i = al.createEvent('Event')).promise = t),
            (i.reason = n),
            i.initEvent(e, !1, !0),
            s.dispatchEvent(i))
      ...
      bl = function(e, t) {
        Xs.call(s, function() {
          ...
          if (
            ...
            ((n = Qs(function() {
              fl
                ? ol.emit('unhandledRejection', i, e)
                : yl('unhandledrejection', e, i);
            })),
      ...
      kl = function(e, t) {
        Xs.call(s, function() {
          fl
            ? ol.emit('rejectionHandled', e)
            : yl('rejectionhandled', e, t.value);
        });
      },
      Tl = function(e, t, n, i) {
        return function(r) {
    ...
    pl &&
      ((il = function(e) {
        Ci(this, il, Zs), Je(e), Bs.call(this);
        var t = el(this);
        try {
      ...
      Ce({ global: !0, wrap: !0, forced: pl }, { Promise: il }),
      Xe(il, Zs, !1),
      ds(Zs),
      (Ws = Z.Promise),
      Ce(
        { target: Zs, stat: !0, forced: pl },
        {
          reject: function(e) {
            var t = ul(this);
    ...
    var Al = ''.startsWith,
      xl = Math.min;
    Ce(
      { target: 'String', proto: !0, forced: !Po('startsWith') },
      {
        startsWith: function(e) {
          var t = String(y(this));
          Ao(e);
          var n = oe(
              xl(arguments.length > 1 ? arguments[1] : void 0, t.length)
            ),
            i = String(e);
    ...
    var Pl,
      ...
      Ul = function(e) {
        return (
          Ol(e) ||
          ((Nl(e) || _l(e) || Rl(e)) && !e.length) ||
          (jl(e) && !Object.keys(e).length)
        );
      },
      Fl = {
        nullOrUndefined: Ol,
    ...
    function Gl() {
      ...
      return Fl.object(r)
        ? (Object.keys(r).forEach(function(t) {
            Fl.object(r[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, Da({}, t, {})),
                Gl(e[t], r[t]))
              : Object.assign(e, Da({}, t, r[t]));
          }),
          Gl.apply(void 0, [e].concat(n)))
        : e;
    }
    function Ql(e, t) {
      var n = e.length ? e : [e];
    ...
    function ec(e) {
      Fl.nodeList(e) || Fl.array(e)
        ? Array.from(e).forEach(ec)
        : Fl.element(e) &&
          Fl.element(e.parentNode) &&
    ...
    function nc(e, t) {
      return Fl.element(t) && Fl.element(t.parentNode) && Fl.element(e)
    ...
    var hc,
      ...
      dc = {
        ...
        pip: !(
          Hl.isIPhone ||
          (!Fl.function(Jl('video').webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled ||
              Jl('video').disablePictureInPicture))
        ),
        ...
        rangeInput:
          ((hc = document.createElement('input')),
          (hc.type = 'range'),
          'range' === hc.type),
    ...
    function pc(e) {
      return (
        !!(Fl.array(e) || (Fl.string(e) && e.includes(':'))) &&
        (Fl.array(e) ? e : e.split(':')).map(Number).every(Fl.number)
      );
    }
    function mc(e) {
      ...
      for (
        var Cc = function(e, t) {
            var n = this instanceof Cc,
              i = si(e),
              r = void 0 === t;
            return !n && i && e.constructor === Cc && r
              ? e
              : ro(
                  Pc
                    ? new Sc(i && !r ? e.source : e, t)
                    : Sc(
                        (i = e instanceof Cc) ? e.source : e,
                        i && r ? Mn.call(e) : t
                      ),
                  n ? this : Ec,
                  Cc
    ...
    var Yc = {
      getIconUrl: function() {
        var e =
          ...
          (Hl.isIE && !window.svg4everybody);
        return { url: this.config.iconUrl, cors: e };
      },
      findElements: function() {
        try {
          return (
            (this.elements.controls = cc.call(
              this,
            ...
            (this.elements.progress = cc.call(
              this,
            ...
            Fl.element(this.elements.progress) &&
      ...
      createIcon: function(e, t) {
        ...
        Xl(r, Gl(t, { role: 'presentation', focusable: 'false' }));
      ...
      createBadge: function(e) {
        ...
        var t = Jl('span', { class: this.config.classNames.menu.value });
        return (
          t.appendChild(
            Jl('span', { class: this.config.classNames.menu.badge }, e)
          ),
          t
        );
      },
      createButton: function(e, t) {
        ...
        return (
          a.toggle
            ? (o.appendChild(
                Yc.createIcon.call(this, a.iconPressed, {
                  class: 'icon--pressed',
                })
              ),
              o.appendChild(
                Yc.createIcon.call(this, a.icon, { class: 'icon--not-pressed' })
              ),
              o.appendChild(
                Yc.createLabel.call(this, a.labelPressed, {
                  class: 'label--pressed',
                })
              ),
              o.appendChild(
                Yc.createLabel.call(this, a.label, {
          ...
          Xl(o, i),
          'play' === r
            ? (Fl.array(this.elements.buttons[r]) ||
      ...
      createRange: function(e, t) {
        var n = Jl(
          'input',
          Gl(
            ic(this.config.selectors.inputs[e]),
            {
              type: 'range',
              min: 0,
              max: 100,
      ...
      createProgress: function(e, t) {
        var n = Jl(
          'progress',
          Gl(
            ic(this.config.selectors.display[e]),
            {
              min: 0,
              max: 100,
              value: 0,
                ...
                32 !== i.which &&
                  (40 === i.which || (a && 39 === i.which)
                    ? ((r = e.nextElementSibling),
                      Fl.element(r) || (r = e.parentNode.firstElementChild))
      ...
      updateVolume: function() {
        this.supported.ui &&
          (Fl.element(this.elements.inputs.volume) &&
            Yc.setRange.call(
              this,
              this.elements.inputs.volume,
              this.muted ? 0 : this.volume
            ),
          Fl.element(this.elements.buttons.mute) &&
            ...
            switch (e.type) {
              ...
              case 'seeked':
                (n = (function(e, t) {
                  ...
                  'timeupdate' === e.type &&
                    Yc.setRange.call(this, this.elements.inputs.seek, n);
                break;
              case 'playing':
              case 'progress':
                !(function(e, n) {
      ...
      updateSeekTooltip: function(e) {
        ...
        if (
          ...
          Fl.element(this.elements.inputs.seek) &&
          Fl.element(this.elements.display.seekTooltip) &&
          0 !== this.duration
        ) {
      ...
      timeUpdate: function(e) {
        var t =
          !Fl.element(this.elements.display.duration) && this.config.invertTime;
        Yc.updateTimeDisplay.call(
          this,
      ...
      durationUpdate: function() {
        if (
          ...
          if (this.duration >= Math.pow(2, 32))
            return (
              rc(this.elements.display.currentTime, !0),
      ...
      updateSetting: function(e, t, n) {
        ...
        if (
          (Fl.element(a) || (a = i && i.querySelector('[role="menu"]')),
          Fl.element(a))
        ) {
          this.elements.settings.buttons[e].querySelector(
            '.'.concat(this.config.classNames.menu.value)
          ).innerHTML = Yc.getLabel.call(this, e, r);
      ...
      setQualityMenu: function(e) {
        ...
        if (Fl.element(this.elements.settings.panels.quality)) {
          ...
          Fl.array(e) &&
            (this.options.quality = bc(e).filter(function(e) {
              return t.config.quality.options.includes(e);
            }));
          var i =
            !Fl.empty(this.options.quality) && this.options.quality.length > 1;
          if (
            (Yc.toggleMenuButton.call(this, 'quality', i),
            tc(n),
      ...
      setCaptionsMenu: function() {
        ...
        if (Fl.element(this.elements.settings.panels.captions)) {
          var t = this.elements.settings.panels.captions.querySelector(
            ...
            i = Boolean(n.length);
          if (
            (Yc.toggleMenuButton.call(this, 'captions', i),
            tc(t),
            Yc.checkMenu.call(this),
            i)
          ) {
            var r = n.map(function(n, i) {
              return {
                ...
                badge:
                  n.language &&
                  Yc.createBadge.call(e, n.language.toUpperCase()),
                list: t,
                type: 'language',
              };
            });
      ...
      setSpeedMenu: function(e) {
        ...
        if (Fl.element(this.elements.settings.panels.speed)) {
          ...
          var i =
            !Fl.empty(this.options.speed) && this.options.speed.length > 1;
      ...
      toggleMenu: function(e) {
        ...
        if (Fl.element(t) && Fl.element(n)) {
          var i = t.hidden,
            r = i;
          if (Fl.boolean(e)) r = e;
          else if (Fl.keyboardEvent(e) && 27 === e.which) r = !1;
          else if (Fl.event(e)) {
            var a = Fl.function(e.composedPath)
                ? e.composedPath()[0]
                : e.target,
              o = t.contains(a);
          ...
          n.setAttribute('aria-expanded', r),
            ...
            r && Fl.keyboardEvent(e)
              ? Yc.focusFirstMenuItem.call(this, null, !0)
              : r || i || uc.call(this, n, Fl.keyboardEvent(e));
        }
      },
      ...
      create: function(e) {
        ...
        return (
          bc(this.config.controls).forEach(function(s) {
            if (
              ...
              if (
                ...
                p.appendChild(
                  a.call(
                    t,
                    'volume',
                    Gl(m, { id: 'plyr-volume-'.concat(e.id) })
                  )
                );
              }
            }
            if (
              ...
              var v = Jl('div', {
                ...
                y = Jl('div'),
                b = Jl('div', { id: 'plyr-settings-'.concat(e.id, '-home') }),
                w = Jl('div', { role: 'menu' });
              b.appendChild(w),
                y.appendChild(b),
                ...
                t.config.settings.forEach(function(i) {
                  var r = Jl(
                    'button',
                    Gl(ic(t.config.selectors.buttons.settings), {
                      type: 'button',
                      class: ''
                  ...
                  var a = Jl('span', null, Fc(i, t.config)),
                    o = Jl('span', { class: t.config.classNames.menu.value });
                  (o.innerHTML = e[i]),
                    a.appendChild(o),
                    r.appendChild(a),
                    w.appendChild(r);
                  ...
                  l.appendChild(
                    Jl('span', { 'aria-hidden': !0 }, Fc(i, t.config))
                  ),
                    l.appendChild(
                      Jl(
                        'span',
                    ...
                    s.appendChild(l),
                    s.appendChild(Jl('div', { role: 'menu' })),
                    y.appendChild(s),
            ...
            if (
              ('pip' === s && dc.pip && u.appendChild(i.call(t, 'pip', h)),
              'airplay' === s &&
                dc.airplay &&
              ...
              !Fl.url(T) &&
                t.isEmbed &&
                Gl(k, { icon: 'logo-'.concat(t.provider), label: t.provider }),
      ...
      inject: function() {
        ...
        var i = {
          ...
          r = !0;
        Fl.function(this.config.controls) &&
          (this.config.controls = this.config.controls.call(this, i)),
          this.config.controls || (this.config.controls = []),
          Fl.element(this.config.controls) || Fl.string(this.config.controls)
            ? (n = this.config.controls)
            : ((n = Yc.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
        ...
        if (
          (r &&
            (Fl.string(this.config.controls)
              ? (n = o(n))
              : Fl.element(n) && (n.innerHTML = o(n.innerHTML))),
          Fl.string(this.config.selectors.controls.container) &&
            (a = document.querySelector(
              this.config.selectors.controls.container
            )),
          Fl.element(a) || (a = this.elements.container),
          a[Fl.element(n) ? 'insertAdjacentElement' : 'insertAdjacentHTML'](
            'afterbegin',
            n
          ),
    ...
    var Xc = {
        setup: function() {
          if (this.supported.ui)
            if (
              !this.isVideo ||
              this.isYouTube ||
              (this.isHTML5 && !dc.textTracks)
            )
              Fl.array(this.config.controls) &&
                this.config.controls.includes('settings') &&
                this.config.settings.includes('captions') &&
                Yc.setCaptionsMenu.call(this);
            else {
              if (
                (Fl.element(this.elements.captions) ||
                  ((this.elements.captions = Jl(
                    'div',
                    ic(this.config.selectors.captions)
                  )),
                  (function(e, t) {
                    Fl.element(e) &&
                      Fl.element(t) &&
              ...
              if (
                (Fl.boolean(i) || (i = this.config.captions.active),
        ...
        update: function() {
          ...
          this.isHTML5 &&
            ...
            ((s && this.language !== r) || !t.includes(o)) &&
              (Xc.setLanguage.call(this, r), Xc.toggle.call(this, i && s)),
            ac(
        ...
        getLabel: function(e) {
          ...
          return (
            !Fl.track(t) &&
              ...
              (t = Xc.getCurrentTrack.call(this)),
            Fl.track(t)
              ? Fl.empty(t.label)
                ? Fl.empty(t.language)
                  ? Fc('enabled', this.config)
                  : e.language.toUpperCase()
                : t.label
              : Fc('disabled', this.config)
          );
        },
      ...
      eu = 'inline',
      tu = { html5: 'html5', youtube: 'youtube', vimeo: 'vimeo' },
      nu = { audio: 'audio', video: 'video' };
    var iu = function() {},
      ru = (function() {
        function e() {
          var t =
        ...
        function e(t) {
          ...
          Ua(this, e),
            ...
            zl.call(
              ...
              'dblclick',
              function(e) {
                (Fl.element(n.player.elements.controls) &&
          ...
          qa(
            ...
            [
              ...
              },
              {
                ...
                value: function() {
                  this.enabled &&
                    (Hl.isIos && this.player.config.fullscreen.iosNative
                      ? this.target.webkitEnterFullscreen()
                      : !e.native || this.forceFallback
                      ? ou.call(this, !0)
                      : this.prefix
                      ? Fl.empty(this.prefix) ||
                        this.target[
                          ''
              ...
              },
              {
                ...
                value: function() {
                  if (this.enabled)
                    ...
                    else if (!e.native || this.forceFallback) ou.call(this, !1);
                    else if (this.prefix) {
              ...
              },
              {
                key: 'target',
                get: function() {
                  return Hl.isIos && this.player.config.fullscreen.iosNative
                    ? this.player.media
                    : this.player.elements.container;
                },
              },
    ...
    var uu = {
        ...
        build: function() {
          ...
          Fl.element(this.elements.controls) ||
            (Yc.inject.call(this), this.listeners.controls()),
            ...
            ac(
              ...
              dc.pip && this.isHTML5 && this.isVideo
            ),
            ac(
              this.elements.container,
              this.config.classNames.airplay.supported,
              dc.airplay && this.isHTML5
            ),
            ...
            this.poster &&
              uu.setPoster.call(this, this.poster, !1).catch(function() {}),
            this.config.duration && Yc.durationUpdate.call(this);
        },
        setTitle: function() {
          var e = Fc('play', this.config);
          if (
            (Fl.string(this.config.title) &&
              !Fl.empty(this.config.title) &&
            ...
            ? (this.media.setAttribute('poster', e),
              function() {
                ...
                return new Promise(function(t) {
                  return e.ready
                    ? setTimeout(t, 0)
                    : zl.call(e, e.elements.container, 'ready', t);
                }).then(function() {});
              }
                .call(this)
                .then(function() {
        ...
        checkPlaying: function(e) {
          ...
          ac(
            ...
            (Fl.event(e) && 'timeupdate' === e.type) ||
              uu.toggleControls.call(this);
        },
          ...
          qa(e, [
            ...
            },
            {
              ...
              value: function() {
                ...
                t.config.keyboard.global &&
                  Bl.call(t, window, 'keydown keyup', this.handleKey, e, !1),
            ...
            },
            {
              ...
              value: function() {
                ...
                !t.keyboard.global &&
                  t.keyboard.focused &&
                  zl.call(e, n.container, 'keydown keyup', this.handleKey, !1),
                  zl.call(
                    e,
                    n.container,
                ...
                zl.call(
                  ...
                  function(t) {
                    ...
                    if (
                      o === n.container &&
                      (e.isEmbed || !Fl.empty(e.config.ratio))
                    ) {
                      ...
                      !(function(t, n, i) {
                        ...
                        s ||
                          (l
                            ? zl.call(e, window, 'resize', a)
                            : Wl.call(e, window, 'resize', a));
                    }
                  }
                );
              },
            },
            {
              ...
              value: function() {
                var e = this,
                  ...
                  n = t.elements;
                if (
                  (zl.call(t, t.media, 'timeupdate seeking seeked', function(
                    e
                  ) {
            ...
            },
            {
              ...
              value: function() {
                    ...
                    function(e) {
                      ...
                      [13, 32].includes(n) &&
                        (13 !== n
                          ...
                          : Yc.focusFirstMenuItem.call(t, null, !0));
                    },
                    null,
                    !1
                  ),
                ...
                this.bind(
                  ...
                  Hl.isWebkit &&
                    Array.from(lc.call(t, 'input[type="range"]')).forEach(
                      function(n) {
    ...
    var gu = Math.max,
      vu = Math.min;
    Ce(
      { target: 'Array', proto: !0, forced: !kn('splice') },
      {
        splice: function(e, t) {
          var n,
            i,
    ...
    var ku = {
      setup: function() {
        ...
        ac(this.elements.wrapper, this.config.classNames.embed, !0),
          vc.call(this),
          Fl.object(window.Vimeo)
            ? ku.ready.call(this)
            : bu(this.config.urls.vimeo.sdk)
                .then(function() {
                  ku.ready.call(e);
                })
                .catch(function(t) {
      ...
      ready: function() {
        ...
        Object.defineProperty(t.media, 'loop', {
          ...
          t.embed.on('loaded', function() {
            ...
            Fl.element(t.embed.element) && t.supported.ui) &&
    ...
    var Eu = {
        ...
        getTitle: function(e) {
          var t = this;
          Dc(Oc(this.config.urls.youtube.api, e))
            .then(function(e) {
              if (Fl.object(e)) {
                var n = e.title,
                  i = e.height,
          ...
          this.media
            ? (ac(
              ...
              this.isHTML5
                ...
                : this.isYouTube
                ? Eu.setup.call(this)
                : this.isVimeo && ku.setup.call(this))
          ...
          qa(e, [
            {
              ...
              value: function() {
                var e = this;
                this.enabled &&
                  (Fl.object(window.google) && Fl.object(window.google.ima)
                    ? this.ready()
                    : bu(this.player.config.urls.googleIMA.sdk)
                        .then(function() {
                          e.ready();
                        })
                        .catch(function() {
              ...
              value: function() {
                ...
                this.countdownTimer = setInterval(function() {
                  var t = $c(Math.max(e.manager.getRemainingTime(), 0)),
                    n = ''
                      .concat(Fc('advertisement', e.player.config), ' - ')
                      .concat(t);
            ...
            },
            {
              ...
              value: function(e, t) {
                return (
                  Fl.array(this.events[e]) || (this.events[e] = []),
            ...
            },
            {
              ...
              value: function(e) {
                Fl.nullOrUndefined(this.safetyTimer) ||
                  (this.player.debug.log(
            ...
            },
            {
              ...
              get: function() {
                ...
                return (
                  ...
                  this.player.isVideo &&
                  e.enabled &&
                  (!Fl.empty(e.publisherId) || Fl.url(e.tagUrl))
                );
              },
            },
            {
    ...
    'findIndex' in [] &&
      ...
      Ce(
        { target: 'Array', proto: !0, forced: Cu },
        {
            ...
            },
            {
              ...
              value: function() {
                ...
                (this.elements.thumb.time = Jl('span', {}, '00:00')),
                  ...
                  Fl.element(this.player.elements.progress) &&
              ...
              this.destroy.call(
                ...
                function() {
                  (t.options.quality = []),
                    ec(t.media),
                    (t.media = null),
                    Fl.element(t.elements.container) &&
                  ...
                  Object.assign(t, {
                    ...
                    t.isHTML5 &&
                      ...
                      Lu.insertElements.call(t, 'track', e.tracks),
      ...
      Ou = (function() {
        function e(t, n) {
          ...
          if (
            ...
            (this.touch = dc.touch),
            (this.media = t),
            Fl.string(this.media) &&
              (this.media = document.querySelectorAll(this.media)),
            ((window.jQuery && this.media instanceof jQuery) ||
              Fl.nodeList(this.media) ||
              Fl.array(this.media)) &&
            ...
            if (this.media.plyr) this.debug.warn('Target already setup');
              ...
              if (dc.check().api) {
                ...
                switch (a) {
                  case 'div':
                    if (
                      ((o = this.media.querySelector('iframe')), Fl.element(o))
                    ) {
                      if (
                        ((s = Gc(o.getAttribute('src'))),
                    ...
                    if (
                      Fl.empty(this.provider) ||
                      !Object.keys(tu).includes(this.provider)
                    )
                ...
                (this.supported = dc.check(
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      Fl.element(this.elements.container) ||
                        ((this.elements.container = Jl('div', { tabindex: 0 })),
                      ...
                      this.config.previewThumbnails.enabled &&
                        (this.previewThumbnails = new Iu(this)))
            ...
            [
              {
                ...
                value: function() {
                  var e = this;
                  return Fl.function(this.media.play)
                    ? (this.ads &&
                        this.ads.enabled &&
              ...
              },
              {
                ...
                value: function() {
                  this.isHTML5
                    ...
                    : Fl.function(this.media.stop) && this.media.stop();
                },
              },
              {
                key: 'restart',
              ...
              },
              {
                ...
                value: function(e) {
                  this.currentTime =
                    this.currentTime -
                    (Fl.number(e) ? e : this.config.seekTime);
                },
              },
              {
                key: 'forward',
                ...
                value: function(e) {
                  if (this.supported.ui && !this.isAudio) {
                    ...
                    if (
                      (i &&
                        this.config.controls.includes('settings') &&
                        !Fl.empty(this.config.settings) &&
                        Yc.toggleMenu.call(this, !1),
                      i !== t)
                    ) {
                ...
                value: function(e) {
                  ...
                  if (this.ready) {
                    ...
                    this.stop(),
                      ...
                      this.isHTML5
                        ? (uu.toggleNativeControls.call(this, !0), i())
                        : this.isYouTube
                        ? (clearInterval(this.timers.buffering),
                          clearInterval(this.timers.playing),
                          null !== this.embed &&
                            Fl.function(this.embed.destroy) &&
                            this.embed.destroy(),
                          i())
                        : this.isVimeo &&
              ...
              },
              {
                ...
                get: function() {
                  return this.isYouTube
                    ? Math.min.apply(Math, Va(this.options.speed))
                    : this.isVimeo
                    ? 0.5
                    : 0.0625;
                },
              },
              {
                ...
                get: function() {
                  return this.isYouTube
                    ? Math.max.apply(Math, Va(this.options.speed))
                    : this.isVimeo
                    ? 2
                    : 16;
                },
              ...
              },
              {
                ...
                set: function(e) {
                  this.isVideo
                    ? uu.setPoster.call(this, e, !1).catch(function() {})
              ...
              },
              {
                ...
                set: function(e) {
                  this.isVideo
                    ? Fl.string(e) && pc(e)
                      ? ((this.config.ratio = e), vc.call(this))
                      : this.debug.error(
              ...
              },
              {
                ...
                set: function(e) {
                  if (dc.pip) {
                    ...
                    Fl.function(this.media.webkitSetPresentationMode) &&
                      this.media.webkitSetPresentationMode(t ? Zc : eu),
                      Fl.function(this.media.requestPictureInPicture) &&
                        (!this.pip && t
                ...
                get: function() {
                  return dc.pip
                    ? Fl.empty(this.media.webkitPresentationMode)
                      ? this.media === document.pictureInPictureElement
                      : this.media.webkitPresentationMode === Zc
                    : null;
                },
              },
            ],
                ...
                value: function(t) {
                  ...
                  return (
                    Fl.string(t)
                      ...
                      : Fl.nodeList(t)
                      ? (i = Array.from(t))
                      : Fl.array(t) && (i = t.filter(Fl.element)),
                    Fl.empty(i)
                      ? null
                      : i.map(function(t) {
                          return new e(t, n);
